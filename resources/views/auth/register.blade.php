    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-5/12 bg-slate-700 p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="name" class="mb-2 block font-semibold uppercase text-gray-300">Nombre</label>
                ...
                <div class="mb-5">
                    <label for="username" class="mb-2 block font-semibold uppercase text-gray-300">Username</label>
                ...
                <div class="mb-5">
                    <label for="password_confirmation" class="mb-2 block font-semibold uppercase text-gray-300">Repetir
                        Password</label>
